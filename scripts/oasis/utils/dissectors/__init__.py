from oasis.utils.dissectors import alert, monitor, timing, metric
...
message_types = {
    ...
    0xF3 : {"type":"METRIC", "parser":metric.parse_metric_message, "formatter": metric.format_metric_message},
}
